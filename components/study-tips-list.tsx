...
import { studyTips, categoryLabels, type TipCategory } from "@/lib/data";
import { TipCard } from "@/components/tip-card";
import { cn } from "@/lib/utils";

const studyCategories: TipCategory[] = [
  "memorization",
  "focus",
  "exam-prep",
  "note-taking",
...
export function StudyTipsList() {
  ...
  const filteredTips = useMemo(() => {
    let tips =
      activeCategory === "all"
        ? studyTips
        : studyTips.filter((t) => t.category === activeCategory);
